...
| # | Module | Answers |
|---|--------|---------|
| 0 | Guide & Method | How each module works, and the assumptions behind every calculated figure. |
| 1 | Executive Dashboard | Composite screen, headline metrics, margin and return decomposition, earnings-quality flags. |
| 2 | Technical Analysis | Trend, momentum and volatility from price action. |
| 3 | Financial Statements | Reported line items on an Annual, Quarterly or TTM basis, with common-size and growth views. |
| 4 | Cash Flow Quality | Whether reported profit turns into cash, and what it costs to keep the business running. |
| 5 | Intrinsic Valuation | Three-phase DCF, reverse DCF, scenarios, sensitivity grid, cross-method summary. |
| 6 | Peer Comparables | Percentile ranking, growth-versus-valuation regression, peer-implied price ranges. |
| 7 | Risk & Scenarios | Volatility, drawdown, value at risk, expected shortfall, Monte Carlo simulation. |
| 8 | Price & Capital Dynamics | Price against market capitalisation, news context, enterprise value bridge. |
| 9 | Market Leaders | Cross-company ranking by size and revenue, with three-year trajectories. |
